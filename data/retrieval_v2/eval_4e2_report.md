# Phase 4E.2 — final validation

- Timestamp UTC: `2026-09-20T22:08:32.747497+00:00`
- Phase-4E and Phase-4E.1 artifacts were treated as immutable baselines.
...
- Baseline v1 Recall@5: `0.64`
- Baseline v2 Recall@5: `0.86`

## Corrected evaluation composition

- Total: 70; answerable: 50; no-answer: 20
- Corrected dataset SHA-256: `1FB72325471FC45E2401F13DB7BA2637B7EC3EB036DF44B69DF1720540097BFE`

## Dense/ranking calibration

{
  "recommended": {
    "type": "top1_dense",
    "threshold": 0.825,
    "rule": "accept only when top1 dense score is at least the proposed threshold; production configuration unchanged",
    "evidence": {
      "threshold": 0.825,
      "answerable_acceptance_recall": 0.74,
      "no_answer_rejection": 1.0,
      "false_acceptance_rate": 0.0,
      "false_rejection_rate": 0.26,
      "balanced_accuracy": 0.87,
      "precision_answerable": 1.0,
      "f1": 0.8505747126436781
    },
    "no_answer_rejection_by_language": {
      "fr": 1.0,
      "en": 1.0,
      "ar": 1.0,
      "es": 1.0
  ...
  "threshold_comparisons": {
    "0.82": {
      "threshold": 0.82,
      "answerable_acceptance_recall": 0.84,
      "no_answer_rejection": 0.95,
      "false_acceptance_rate": 0.05,
      "false_rejection_rate": 0.16000000000000003,
      "balanced_accuracy": 0.895,
      "precision_answerable": 0.9767441860465116,
    ...
    "0.83": {
      "threshold": 0.83,
      "answerable_acceptance_recall": 0.7,
      "no_answer_rejection": 1.0,
      "false_acceptance_rate": 0.0,
      "false_rejection_rate": 0.30000000000000004,
...
{
  "strict_query_count": 8,
  "frozen": {
    "requested_year_context_rate": 0.875,
    "conflicting_year_context_rate": 0.875,
    "family_recall_at_5": 0.875
  },
  "experimental": {
    "requested_year_context_rate": 0.875,
    "conflicting_year_context_rate": 0.125,
    "family_recall_at_5": 0.875
  }
}
...
No production configuration or corpus artifact was changed.
